...
export default createCommand(
    builder => builder.setName('prompt').setDescription('Prompt for the bot').addStringOption(option => option.setName('input').setRequired(true).setDescription('The prompt')),
    async interaction => {
